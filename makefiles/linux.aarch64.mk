...
sys_ha = sys/+linux/+aarch64.ha sys/+linux/errno.ha sys/+linux/prctl.ha sys/+linux/signal.ha sys/+linux/socket.ha sys/+linux/stat.ha sys/+linux/syscallno+aarch64.ha sys/+linux/syscalls.ha sys/+linux/types.ha sys/u64tos.ha sys/unknown_errno.ha
$(HARECACHE)/sys.ssa: $(sys_ha)
	@mkdir -p -- "$(HARECACHE)"
	@printf 'HAREC\t%s\n' "$@"
	@$(TDENV) $(HAREC) $(HARECFLAGS) -o $@ -t $(HARECACHE)/sys.td.tmp -N sys $(sys_ha)

sys_s = $(HARECACHE)/sys.s sys/+linux/syscall+aarch64.s
...
io_ha = io/+linux/dup.ha io/+linux/mmap.ha io/+linux/platform_file.ha io/+linux/sync.ha io/+linux/vector.ha io/arch+aarch64.ha io/copy.ha io/drain.ha io/empty.ha io/file.ha io/handle.ha io/limit.ha io/stream.ha io/tee.ha io/types.ha io/unread.ha io/util.ha io/zero.ha
...
time_ha = time/+linux/+aarch64.ha time/+linux/functions.ha time/arithm.ha time/duration.ha time/instant.ha
