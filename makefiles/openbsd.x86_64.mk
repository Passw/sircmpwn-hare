...
sys_ha = sys/+openbsd/+x86_64.ha sys/+openbsd/dynamic_linker.ha sys/+openbsd/errno.ha sys/+openbsd/libc.ha sys/+openbsd/signal.ha sys/+openbsd/socket.ha sys/+openbsd/syscalls.ha sys/+openbsd/types.ha sys/u64tos.ha sys/unknown_errno.ha
...
io_ha = io/+openbsd/dup.ha io/+openbsd/mmap.ha io/+openbsd/platform_file.ha io/+openbsd/sync.ha io/+openbsd/vector.ha io/arch+x86_64.ha io/copy.ha io/drain.ha io/empty.ha io/file.ha io/handle.ha io/limit.ha io/stream.ha io/tee.ha io/types.ha io/unread.ha io/util.ha io/zero.ha
