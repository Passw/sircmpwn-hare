...
sys_ha = sys/+linux/+x86_64.ha sys/+linux/errno.ha sys/+linux/prctl.ha sys/+linux/signal.ha sys/+linux/socket.ha sys/+linux/stat.ha sys/+linux/syscallno+x86_64.ha sys/+linux/syscalls.ha sys/+linux/types.ha sys/u64tos.ha sys/unknown_errno.ha
$(HARECACHE)/sys.ssa: $(sys_ha)
	@mkdir -p -- "$(HARECACHE)"
	@printf 'HAREC\t%s\n' "$@"
	@$(TDENV) $(HAREC) $(HARECFLAGS) -o $@ -t $(HARECACHE)/sys.td.tmp -N sys $(sys_ha)

sys_s = $(HARECACHE)/sys.s sys/+linux/syscall+x86_64.s
...
rt_s = $(HARECACHE)/rt.s rt/+linux/restore+x86_64.s rt/+linux/start+x86_64-libc.s
$(HARECACHE)/rt.o: $(rt_s)
	@printf 'AS\t%s\n' "$@"
	@$(AS) $(ASFLAGS) -o $@ $(rt_s)
...
io_ha = io/+linux/dup.ha io/+linux/mmap.ha io/+linux/platform_file.ha io/+linux/sync.ha io/+linux/vector.ha io/arch+x86_64.ha io/copy.ha io/drain.ha io/empty.ha io/file.ha io/handle.ha io/limit.ha io/stream.ha io/tee.ha io/types.ha io/unread.ha io/util.ha io/zero.ha
...
time_ha = time/+linux/+x86_64.ha time/+linux/functions.ha time/arithm.ha time/duration.ha time/instant.ha
