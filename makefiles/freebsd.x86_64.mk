...
sys_ha = sys/+freebsd/+x86_64.ha sys/+freebsd/errno.ha sys/+freebsd/signal.ha sys/+freebsd/socket.ha sys/+freebsd/syscallno.ha sys/+freebsd/syscalls.ha sys/+freebsd/types.ha sys/u64tos.ha sys/unknown_errno.ha
$(HARECACHE)/sys.ssa: $(sys_ha)
	@mkdir -p -- "$(HARECACHE)"
	@printf 'HAREC\t%s\n' "$@"
	@$(TDENV) $(HAREC) $(HARECFLAGS) -o $@ -t $(HARECACHE)/sys.td.tmp -N sys $(sys_ha)

sys_s = $(HARECACHE)/sys.s sys/+freebsd/syscall+x86_64.s
...
rt_s = $(HARECACHE)/rt.s rt/+freebsd/brand.s rt/+freebsd/start+x86_64-libc.s
$(HARECACHE)/rt.o: $(rt_s)
	@printf 'AS\t%s\n' "$@"
	@$(AS) $(ASFLAGS) -o $@ $(rt_s)
...
io_ha = io/+freebsd/dup.ha io/+freebsd/mmap.ha io/+freebsd/platform_file.ha io/+freebsd/sync.ha io/+freebsd/vector.ha io/arch+x86_64.ha io/copy.ha io/drain.ha io/empty.ha io/file.ha io/handle.ha io/limit.ha io/stream.ha io/tee.ha io/types.ha io/unread.ha io/util.ha io/zero.ha
